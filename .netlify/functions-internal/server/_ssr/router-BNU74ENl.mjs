...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BNU74ENl.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-DoFrk_wq.css";
...
var Route$1 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Live online German classes — A1 to B1."
			},
			{
...
var $$splitComponentImporter = () => import("./routes-BC8nJkO_.mjs");
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Premium live online German language academy. A1 to B1 courses with speaking practice, small batches, and career-focused mentorship."
			},
			{
				property: "og:title",
				content: "Kee German Academy — A1 to B1"
			},
			{
				property: "og:description",
				content: "Live online German classes for students and professionals. Practical, career-focused learning."
			},
			{
				property: "og:type",
				content: "website"
